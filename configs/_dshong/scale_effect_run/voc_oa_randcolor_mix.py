...
mixture_depth = 1
mixture_width = 1
name = f"voc-oa_randcolor_{oa_version}-faster_rcnn_fpn"
...
train_pipeline = [
    ...
    dict(type='RandomColor', num_views=num_views, use_oa=True, oa_version=oa_version,
         use_mix=use_mix, mixture_depth=mixture_depth, mixture_width=mixture_width),
